...
void RotaryDeltaSolution::cartesian_to_actuator( float cartesian_mm[], float actuator_mm[] )
{
...
void RotaryDeltaSolution::actuator_to_cartesian( float actuator_mm[], float cartesian_mm[] )
{
...
bool RotaryDeltaSolution::get_optional(arm_options_t& options) {
